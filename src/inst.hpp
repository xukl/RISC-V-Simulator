...
enum class inst_op {ADD, SLT, SLTU, AND, OR, XOR, SLL, SRL, SUB, SRA, MUL, MULH, MULHSU, MULHU, DIV, DIVU, REM, REMU, ADDI, SLTI, SLTIU, ANDI, ORI, XORI, SLLI, SRLI, SRAI, LB, LH, LW, LBU, LHU, SB, SH, SW, BEQ, BNE, BLT, BLTU, BGE, BGEU, LUI, AUIPC, JAL, JALR, FENCE, ECALL, EBREAK};
struct ID_inst
{
	uint32_t orig;
	inst_format format;
