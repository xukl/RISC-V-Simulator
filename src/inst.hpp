...
#define INST_HPP
#include <cstdint>
static const uint32_t END_INST_ORIG = 0x0ff00513;
...
static const IF_inst IF_NOP {0x00000013, uint32_t(-4), jump_info(0)};
...
static const ID_inst ID_NOP {IF_NOP.orig, inst_format::I, 0, 0, 0, 0, 0, 0, inst_opcode::OP_IMM, 0, 0, inst_op::ADDI, uint32_t(-4), jump_info(0)};
struct EX_inst
{
	bool finish_flag;
	inst_opcode opcode;
...
static const EX_inst EX_NOP {false, inst_opcode::OP_IMM, 0, 0, 0};
struct MEM_inst
{
	bool finish_flag;
	inst_opcode opcode;
...
static const MEM_inst MEM_NOP {false, inst_opcode::OP_IMM, 0, 0};
#endif
